...
// And return
<f>:
   0:          mov    eax,DWORD PTR [esp+0x4] 	// MOVE o valor do endereço ESP+0x4 para EAX                               
   // EAX: 0x1234; EDX: 0x0;                                                                                               
   4:          bswap  eax 						// Troca a posição dos bytes de um valor, por exemplo: 0x123456 => 0x563412
   // EAX: 0x3412; EDX: 0x0;                                                                                               
   6:          mov    edx,eax 					// Mover o valor de EAX para EDX                                           
   // EAX: 0x3412; EDX: 0x3412;                                                                                            
   8:          and    eax,0xf0f0f0f 			// Faça uma comparação AND com 0x0F0F0F0F e armazene em EAX.               
   // EAX: 0x402; EDX: 0x3412;                                                                                             
   d:          and    edx,0xf0f0f0f0 			// Faça uma comparação AND com 0xF0F0F0F0 e armazene no EDX.               
   // EAX: 0x402; EDX: 0x3010;                                                                                             
  13:          shr    edx,0x4 					// Desloca o binário de EDX 4 bits para a direita (divida por 16).         
   // EAX: 0x402; EDX: 0x301;                                                                                              
  16:          shl    eax,0x4 					// Desloca o binário de EAX 4 bits para a esquerda (multiplique por 2⁴)    
   // EAX: 0x4020; EDX: 0x301;                                                                                             
  19:          or     eax,edx 					// Faça uma comparação OR e armazene em EAX.                               
   // EAX: 0x4321; EDX: 0x301;                                                                                             
  1b:          mov    edx,eax 					// Mover o valor EAX para EDX                                              
   // EAX: 0x4321; EDX: 0x4321;                                                                                            
  1d:          and    eax,0x33333333 			// Faça uma comparação AND e armazene em EAX.                              
   // EAX: 0x321; EDX: 0x4321;                                                                                             
  22:          and    edx,0xcccccccc 			// Faça uma comparação AND e armazene no EDX.                              
   // EAX: 0x321; EDX: 0x4000;                                                                                             
  28:          shr    edx,0x2 					// Desloca o binário de EDX 2 bits para a direita (divida por 4).          
   // EAX: 0x321; EDX: 0x1000;                                                                                             
  2b:          shl    eax,0x2 					// Desloca o binário de EAX 2 bits para a esquerda (multiplique por 2²).   
   // EAX: 0xC84; EDX: 0x1000;                                                                                             
  2e:          or     eax,edx 					// Faça uma comparação OR e armazene em EAX.                               
   // EAX: 0x1C84; EDX: 0x1000;                                                                                            
  30:          mov    edx,eax 					// Mover o valor EAX para EDX                                              
   // EAX: 0x1C84; EDX: 0x1C84;                                                                                            
  32:          and    eax,0x55555555			// Faça uma comparação AND e armazene em EAX.                              
   // EAX: 0x1404; EDX: 0x1C84;                                                                                            
  37:          and    edx,0xaaaaaaaa 			// Faça uma comparação AND e armazene no EDX.                              
   // EAX: 0x1404; EDX: 0x880;                                                                                             
  3d:          add    eax,eax 					// Adicione EAX com EAX (EAX += EAX || EAX*=2)                             
   // EAX: 0x2808; EDX: 0x880;                                                                                             
  3f:          shr    edx,1 					// Desloque o bit binário de EDX 1 para a direita (divida por 2).          
   // EAX: 0x2808; EDX: 0x440;                                                                                             
  41:          or     eax,edx 					// Faça uma comparação OR e armazene em EAX.                               
   // EAX: 0x2C48; EDX: 0x440;                                                                                             
  43:          ret								// Operação de retorno                                                     
